...
public class PlayerApi extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		switch(path) {
			case "getPlayer":{	
				List<Player> PlayerList = service.getPlayers(team);
			...
			case "getPlayerPosition":{
				int positionNo = Integer.parseInt(getParameter("type"));
				List<Player> PlayerList = service.getPlayerPosition(team, positionNo);
