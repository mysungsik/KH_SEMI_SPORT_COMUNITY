	...
	<main>
        <section class="container">
            ...
            <form name="term-form" class="term-form" action="#">
                ...
                <div class="term-div term-page-div">
                    <div class="term-check-div checkbox__blue">
                        <input type="checkbox" id="term-page" name="term-page">
                        <label for="term-page" class="fs-20__b"><span class="fc__dblue fs-12__b">[필수]</span> 페이지 이용 약관</label>
                    </div>
                ...
                <div class="term-div term-personal-div">
                    <div class="term-check-div checkbox__blue">
                        <input type="checkbox" id="term-personal" name="term-personal">
                        <label for="term-personal" class="fs-20__b"><span class="fc__dblue fs-12__b">[필수]</span> 개인정보 수집 및 이용 동의</label>
                    </div>
                    <div class="article-box article__white">
                        <p class="article-title">
                            여러분을 환영합니다.
                ...
                <div class="term-div term-events-div">
                    <div class="term-check-div checkbox__blue">
                        <input type="checkbox" id="term-events" name="term-events">
                        <label for="term-events" class="fs-20__b"><span class="fc__gray fs-12__b">[선택]</span> 이벤트 안내에 관한 동의</label>
                    </div>
                    <div class="article-box article__white">
                        <p class="article-title">
                            여러분을 환영합니다.
                ...
                <!-- 임시 페이지이동 -->
                <button class="btn-big__blue" type="button" onclick="location.href = '/SPORTS_PROJECT/src/pages/signup/signup.jsp';">
                    다음
                </button>
            </form>
        </section>
