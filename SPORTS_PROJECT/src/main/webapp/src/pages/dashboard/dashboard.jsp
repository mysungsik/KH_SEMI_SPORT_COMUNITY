                ...
                <div class="container-left">
                    <div class="current-events card__lblue ">
                        ...
                        <div class="events-date-div d-flex">
                            <img src="/FRONTEND/public/icons/left-arrow.png" class="w-15 h-15" onclick="beforeDay()">
                            <div id="dateDisplay"></div>
                            <img src="/FRONTEND/public/icons/right-arrow.png" class="w-15 h-15" onclick="nextDay()">
                        </div>
                        ...
                        <div class="d-flex arrows">
                            <img src="/FRONTEND/public/icons/left-arrow.png" style="width: 13px; height: 13px;">
                            <img src="/FRONTEND/public/icons/right-arrow.png" style="width: 13px; height: 13px;">
                        </div>
                    </div>
                        ...
                        <div class="main-news-content card__lblue mt-10 swiper swiper-news">
                            ...
                            <div class="news-content-top d-flex swiper-wrapper">
                                <div class="card-thumbnail swiper-slide">
                                    <img class="card-thumbnail-img" src="/FRONTEND/public/images/news_example.jpg">
                            ...
                            <ul>
                                <li class="d-flex">
                                    <div class="score-board-infos">
                                        <img class="score-board-logo" src="/FRONTEND/public/images/teams/FL.png">
