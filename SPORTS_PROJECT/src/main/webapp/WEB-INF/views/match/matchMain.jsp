            ...
            <div class="main">
                ...
                <div class="matchschedule">
                    <video class="main-video" autoplay muted loop>
                        <source src="${contextPath}/public/video/backgroundVideo.mp4" id="backgroundVideo">
                    </video>
                    <div class="videoText">
                    ...
                    <div class="player_record">
                        <div class="box-ranking">
                            ...
                            <div class="profileImage">
                                <img src="${contextPath}/public/images/user_img1.jpg" alt="#" id="playerImage">
                            </div>
                            <ol class="list_ranking"></ol>
                        </div>
                        <div class="box-ranking">
