...
<body>
    ...
    <main>
        <div class="recordTab">
            <a href="teamRanking.jsp" class="nationalLeague box-hover:hover" onclick=""><span>내셔널 리그</span></a>
            <a href="#" class="americanLeague box-hover:hover" onclick=""><span>아메리칸 리그</span></a>
        </div>
