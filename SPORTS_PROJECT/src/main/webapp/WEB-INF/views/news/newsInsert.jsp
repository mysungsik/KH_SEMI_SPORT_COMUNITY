...
<link rel="stylesheet" href="${contextPath}/src/css/newsInsert.css">
<script src="${contextPath}/src/js/newsInsert.js" defer></script>
...
<body>
	...
	<!-- Write Main Content -->
	<main>
		<form action="${contextPath}/api/news/insertNews"  enctype="multipart/form-data" method="post" onsubmit="return writeValidate()">
			<section class="title-area">
				<div class="title">
					<span class="fs-28__b">뉴스 추가</span>
				</div>
				<div class="category">
			...
			<section class="posting-area">
				...
				<div class="input-publisher">
					<input type="text" placeholder="뉴스 발행사" name="publisher" class="fs-14">
				</div>
