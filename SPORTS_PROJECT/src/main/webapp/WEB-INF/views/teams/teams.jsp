            ...
            <section class="main-top">
                <article class="title">
                    <div class="intro-title-desc">
                        ...
                        <p class="fs-14 mt-10"> <img src="/SPORTS_PROJECT/public/icons/right-arrow.png" alt="오른쪽화살표" class="w-20"> <span class="fs-14">구단 정보</span> ∙ 각 구단을 선택하시면 구단의 상세정보를 확인하실 수 있습니다.</p>
                    </div>
                </article>
            </section>
