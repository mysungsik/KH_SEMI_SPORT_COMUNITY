...
<link rel="stylesheet" href="./src/css/teamsEachHeader.css">
...
<body>
	...
	<c:if test="${login}">
			...
			<div class="header-top">
		        ...
		        <div class="header-top-user box-hover dropdown">
		            ...
		            <ul class="dropdown-menu">
		                ...
		                <li><a class="dropdown-item fs-20__b text-hover__blue" href="./src/pages/personal/myInfo.jsp">내 댓글</a></li>
		    ...
		    <div class="header-bot">
		        <div class="header-nav">
		            <ul class="d-flex">
		                <a class="fs-20__b text-hover__blue" href="./src/pages/teams/team.jsp">BLUE JAYS</a>
		                <a class="fs-20__b text-hover__blue" href="./src/pages/teams/players.jsp">PLAYERS</a>
						<a href="./src/pages/teams/eachTeamMain.jsp"><img class="logo" src='./public/images/teams/FL.png'></a>
		                <a class="fs-20__b text-hover__blue" href="./src/pages/teams/schedule.jsp">SCHEDULE</a>
		                <a class="fs-20__b text-hover__blue" href="./src/pages/teams/contents.jsp">CONTENTS</a>
		            </ul>
		        </div>
		    </div>
	</c:if>
	<c:if test="${!login}">
		...
		<div class="header-top">
                ...
                <div class="header-top-user box-hover" onclick="location.href = './src/pages/login/login.jsp'">
